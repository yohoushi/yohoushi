#!/usr/bin/env ruby
# This is copy of https://github.com/mojombo/god/blob/master/bin/god just to put default options[:config]
STDOUT.sync = true
...
begin
  ...
  options[:config] = File.expand_path('../config/yohoushi.god', __FILE__) # add
